...
piButton.addEventListener('click', () => {
    currentValue.textContent = Math.PI;
})
...
multiplyButton.addEventListener('click', () => {
    if (previousValue.textContent) {
        previousValue.textContent = parseInt(previousValue.textContent) * parseInt(currentValue.textContent);
        currentOperator = '*';
    } else {
        previousValue.textContent = currentValue.textContent;
        currentOperator = '*'
...
equalsButton.addEventListener('click', () => {
    previousValue.textContent = currentValue.textContent;
    if (currentOperator == '+') {
        currentValue.textContent = parseInt(previousValue.textContent) + parseInt(currentValue.textContent);
    } if (currentOperator == '-') {
        currentValue.textContent = parseInt(previousValue.textContent) - parseInt(currentValue.textContent);
    } if (currentOperator == '*') {
        currentValue.textContent = parseInt(previousValue.textContent) * parseInt(currentValue.textContent);
